...
|---|---|---|---|---|---|---|
| test | 1min | Univariate MLP Target Lags | 1.510 | 1.896 | 0.960 | first_difference / smooth=none / lr=0.01 |
| test | 30s | Univariate MLP Target Lags | 0.879 | 1.109 | 0.986 | first_difference / smooth=none / lr=0.0001 |
