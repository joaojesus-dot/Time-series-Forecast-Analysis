...
## Metrics
| Split | Granularity | Mae | Rmse | Mape | Smape | Bias | Transform Name | Training Smoothing Window | Learning Rate Init |
|---|---|---|---|---|---|---|---|---|---|
| validation | 1min | 2.032 | 2.576 | 0.264 | 0.264 | -0.010 | first_difference | 1min | 0.010 |
| test | 1min | 2.137 | 2.693 | 0.275 | 0.275 | 0.027 | first_difference | 1min | 0.010 |
| validation | 30s | 1.228 | 1.550 | 0.160 | 0.160 | -0.009 | first_difference | 30s | 0.010 |
| test | 30s | 1.231 | 1.554 | 0.158 | 0.158 | 0.003 | first_difference | 30s | 0.010 |

## Preparation Candidate Ranking
| Granularity | Candidate Label | Difference Order | Training Smoothing Window | Learning Rate Init | Validation Mae | Test Mae |
|---|---|---|---|---|---|---|
| 1min | 1min_d0_smooth_1min | 0 | 1min | 0.010 | 6.417 | 5.972 |
| 1min | 1min_d0_smooth_none | 0 | none | 0.010 | 6.417 | 5.972 |
| 1min | 1min_d1_smooth_1min | 1 | 1min | 0.010 | 2.032 | 2.137 |
| 1min | 1min_d1_smooth_none | 1 | none | 0.010 | 2.032 | 2.137 |
| 1min | 1min_d2_smooth_1min | 2 | 1min | 0.010 | 2.338 | 2.470 |
| 1min | 1min_d2_smooth_none | 2 | none | 0.010 | 2.338 | 2.470 |
| 30s | 30s_d0_smooth_1min | 0 | 1min | 0.010 | 5.859 | 5.505 |
| 30s | 30s_d0_smooth_30s | 0 | 30s | 0.010 | 5.868 | 5.508 |
| 30s | 30s_d0_smooth_none | 0 | none | 0.010 | 5.868 | 5.508 |
| 30s | 30s_d1_smooth_1min | 1 | 1min | 0.010 | 1.236 | 1.239 |
| 30s | 30s_d1_smooth_30s | 1 | 30s | 0.010 | 1.228 | 1.231 |
| 30s | 30s_d1_smooth_none | 1 | none | 0.010 | 1.228 | 1.231 |
| 30s | 30s_d2_smooth_1min | 2 | 1min | 0.010 | 1.487 | 1.463 |
| 30s | 30s_d2_smooth_30s | 2 | 30s | 0.010 | 1.308 | 1.296 |
| 30s | 30s_d2_smooth_none | 2 | none | 0.010 | 1.308 | 1.296 |
